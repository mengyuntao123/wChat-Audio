...
Page({
  data: {
    audiolist:[
      {
        audiosrc:'https://webfs.yun.kugou.com/202002151447/1ff647af4200b79e64a0e648eb2979e3/G187/M05/13/17/W4cBAF4wLYSAUawsADxFYthpjdQ269.mp3',
  ...
  loadaudio() {
    ...
    this.data.durationIntval = setInterval(function () {
      ...
      if (that.data.isPlayAudio == true) {
        ...
        console.log(seek,duration,time) //总时间为100
